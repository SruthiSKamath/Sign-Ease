...
from realtime_detectionA import update_frame, release_video  
import warnings
...
root = ctk.CTk()
root.title("AI Webcam Viewer & Prediction")
...
# Title Label
title_label = ctk.CTkLabel(root, text="American Sign Language", font=("Arial", 24, "bold"))
